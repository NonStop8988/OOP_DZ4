...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        // Создание студентов
        Student student1 = studentService.createStudent(1, "Андрей", "Андреев");
        Student student2 = studentService.createStudent(2, "Наталья", "Иноземцева");
        Student student3 = studentService.createStudent(3, "Павел", "Морковин");
        Student student4 = studentService.createStudent(4, "Кирилл", "Баранов");
        ...
        Student updatedStudent = studentService.createStudent(1, "Андрей", "Филипов");
        groupController1.update(0, updatedStudent);
        Student updatedStudent2 = studentService.createStudent(3, "Михаил", "Морковин");
        ...
        // Создание учителей
        Teacher teacher1 = teacherService.createTeacher(1, "Александра", "Зайцева");
        Teacher teacher2 = teacherService.createTeacher(2, "Евгений", "Тибишко");
        ...
        Teacher updatedTeacher = teacherService.createTeacher(1, "Александра", "Тушич");
